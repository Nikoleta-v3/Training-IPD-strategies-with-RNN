...
if __name__ == "__main__":
    ...
    for seed in range(min_seed, max_seed):
        ...
        for opening_probability in [0, 1, 0.78]:
            ...
            df.to_csv(
                f"{folder_name}/result_summary_{model_type}_seed_{seed}_opening_{opening_probability}_stochastic.csv"
            )
            ...
            df_payoff_matrix.to_csv(
                f"{folder_name}/payoff_matrix_{model_type}_seed_{seed}_opening_{opening_probability}_stochastic.csv"
            )
